    ...
    <div className="w-full bg-[#12937C] flex justify-center ">
      <div className="search-container  h-[204px] width-100 flex flex-col justify-center items-center ">
        <div className="search-text">
          <h1 className="text-[28px] font-[500] mb-5 text-[white] text-center">
        ...
        <div className="search-input">
          <div className="relative bg-white rounded-[20px] shadow-md h-[45px] flex items-center">
            ...
            <input
              ...
              className="focus:outline-none flex-grow text-black w-[200px]"
            />
            ...
            <input
              ...
              className="focus:outline-none flex-grow text-black w-[110px]"
            />
            <button className="bg-blue-500 text-white px-5 h-[45px] rounded-[20px] ml-2">
              GET QUOTES
            </button>
          </div>
        </div>
